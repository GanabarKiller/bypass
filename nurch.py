...
cl = LINE("rahmaayuayu47@gmail.com","sri100585")
cl.log("Auth Token : " + str(cl.authToken))
#==========SB_TEMPLATE========

oepoll = OEPoll(cl)
call = cl
creator = ["u5ce21bec184a1ae48777e2966a136efe"]
owner = ["u7b3bc93109467799eb567983359254fe"]
admin = ["u7b3bc93109467799eb567983359254fe","u5ce21bec184a1ae48777e2966a136efe","uf40315275122ded5f585f182b09183af"]
staff = ["u7b3bc93109467799eb567983359254fe"]
...
settings = {
    ...
    "size": "micro",
    "keyCommand": "dent",
    "commentPost": "ʟⁱᵏᵉ ʟⁱᵏᵉ & ʟⁱᵏᵉ ᴀʲᵃ - ʙʏ : eka fiutama",
    "Aip": False,
    "replySticker": False,
    "stickerOn": False,
    "checkContact": False,
...
wait = {
    ...
    "Respontag":"🛡ᴋᴀɴɢᴇɴ ʏᴀ brow",
    "Respontag2":"🛡ᴋᴀɴɢᴇɴ ʏᴀ brow",
    "welcome":"🛡sᴀʟᴋᴇɴ sᴇᴍᴏɢᴀ ʙᴇᴛᴀʜ ᴋᴀ",
    "autoLeave":"🛡sᴇʟᴀᴍᴀᴛ ᴊᴀʟᴀɴ ᴋᴀk slamat dapat tikungan baru",
    "comment":"ʜᴀᴅɪʀ ɴʏɪᴍᴀᴋ☺☺ʟɪᴋᴇ ʟɪᴋᴇ ʙʏ:eka_vipsmule01",
    "message1":"ᴛʜᴀɴᴋᴢ ғᴏʀᴅ ᴀᴅᴅ ᴍᴇ\nCreator:http://line.me/ti/p/~eka_vipsmule01",
}
protect = {
    "pqr":[],
    "pinv":[],
...
"size": "xxs",
      "aspectMode": "cover",
           "action": {
            "type": "uri",
            "uri": "http://line.me/ti/p/~eka_vipsmule01",
            },
            "flex": 0
          },
          {
    ...
    "contents": [
      ...
      },
      {
        ...
        "contents": [
          {
            "type": "image",
            "url": "https://k.top4top.io/p_2318v62lp2.png",
            "align": "center",
            "size": "full",
            "aspectRatio": "1:3",
            "aspectMode": "cover"
  ...
  "contents": [
    {
      ...
      "body": {
        ...
        "contents": [
          {
            "type": "image",
            "url": "https://i.ibb.co/dLBpwwG/line-174558824424280.jpg",
            "size": "full",
            "aspectMode": "cover",
            "aspectRatio": "2:3",
            "gravity": "top"
                 ...
                 if wait["Mentionkick"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           sendTextTemplate1(msg.to,"𝑳𝒖𝒘 𝒕𝒂𝒈 𝒈𝒖𝒆,𝒔𝒖𝒌𝒂 𝒚𝒂𝒄𝒉")
                           cl.kickoutFromGroup(msg.to, [msg._from])
                           break
               if msg.contentMetadata is not None and 'MENTION' in msg.contentMetadata:
...
"action": {
"type": "uri",
"uri": "Https://smule.com/EKA_VIPSMULE01",
},
"flex": 0
}
],
                        ...
                        if cmd == "bot on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               data = {
                                       "type": "flex",
                                       "altText": "➥ 􀰂􀰂͜͡ ⃟ཽ ⃟ ⃟ཽ ⃟̷̡͈͙̖̳̬̼͓̌̓͐̂͗͢͝ͅ҉̵̵̧̹͖̤̝͎̖͂̾͐̈̔̎̌̍͒͌͒͡҉̵̛̖͖̊̄̃͆͋͒̃ͅ➴̴̗̟̭̠̳͚͊̐͐͂̆̓҉̶̶̢̡̛̳̬̞̲̹̘̄̿͒̓̓̓̀́̓͜͜͝ͅͅ҉̷̨̡̨̹̯̗͕̟̩͚̎̂nurch΃ཽᬽ͢͢􏿿 ",
                                       "contents": {
  "type": "carousel",
  "contents": [
    {
